...
Generated 2026-09-17 17:25 UTC. This file is written by a scheduled job -- nobody has to ask for it.

## Collection

- **1,602 closed round trips**, all collector v3, Aug 05 to Sep 17
- Newest trade **9 min old**
- **20 in the last 24h**, 43 in the last 7 days (6.1/day across 4 tracked wallets)
- **+3 since the last report** (2026-09-17 16:39 UTC)

## Detection lag

How stale a trade already was when the collector noticed it. This is what execution lag a row actually represents.

- Last 2 days: **median 12.4s**, p90 13.6s (33 rows)
...
|---|---|---|---|---|---|---|---|
| Cented | 2 | 28 more | +2.49 | 50% | 50% | 0.251 | 40.8 d ago |
| Sebastian | 1 | 29 more | +2.26 | 100% | 100% | nan | 42.6 d ago |
...
| Dani | UNPROVEN | 114 | +29.08 | 49% | 58% | -4.93 | 0.160 |
...
| Loopierr | INSUFFICIENT | 14 | -12.34 | 43% | 50% | -18.36 | 0.863 |
