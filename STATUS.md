...
Generated 2026-09-06 02:00 UTC. This file is written by a scheduled job -- nobody has to ask for it.

## Collection

- **1,540 closed round trips**, all collector v3, Aug 05 to Sep 05
- Newest trade **4.7 h old**
- **5 in the last 24h**, 32 in the last 7 days (4.6/day across 4 tracked wallets)
- **+1 since the last report** (2026-09-06 01:30 UTC)

## Detection lag

How stale a trade already was when the collector noticed it. This is what execution lag a row actually represents.

- Last 2 days: **median 12.4s**, p90 16.0s (11 rows)
...
|---|---|---|---|---|---|---|---|
| theo | 29 | 1 more | +43.94 | 83% | 92% | 0.000 | 4.7 h ago |
| Sheep | 27 | 3 more | +27.55 | 78% | 85% | 0.000 | 3.1 d ago |
