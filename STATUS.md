...
Generated 2026-09-26 12:12 UTC. This file is written by a scheduled job -- nobody has to ask for it.

## Collection

- **1,661 closed round trips**, all collector v3, Aug 05 to Sep 25
- Newest trade **12.7 h old**  ⚠️ collector may be stuck
- **4 in the last 24h**, 48 in the last 7 days (6.9/day across 5 tracked wallets)
- **+0 since the last report** (2026-09-26 11:45 UTC)

## Detection lag

How stale a trade already was when the collector noticed it. This is what execution lag a row actually represents.

- Last 2 days: **median 2.4s**, p90 3.0s (10 rows)
...
|---|---|---|---|---|---|---|---|
| Cented | 2 | 28 more | +2.49 | 50% | 50% | 0.251 | 49.5 d ago |
| Sebastian | 1 | 29 more | +2.26 | 100% | 100% | nan | 51.3 d ago |

- Cented needs 28 more trades; at its recent rate that is roughly 20 days away.
- Sebastian needs 29 more trades; at its recent rate that is roughly 21 days away.

## Tracked wallets that have gone quiet

- **Pikalosi** — last trade never seen. Costs ~43,200 RPC calls/day regardless.
- **Pavel** — last trade never seen. Costs ~43,200 RPC calls/day regardless.
