...
Generated 2026-09-17 21:56 UTC. This file is written by a scheduled job -- nobody has to ask for it.
...
- **+0 since the last report** (2026-09-17 17:25 UTC)

## Detection lag

How stale a trade already was when the collector noticed it. This is what execution lag a row actually represents.

- Last 2 days: **median 12.5s**, p90 13.4s (28 rows)
- Before that: median 18.2s, p90 35.5s (1491 rows)
...
| Sebastian | 1 | 29 more | +2.26 | 100% | 100% | nan | 42.7 d ago |
