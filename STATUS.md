...
Generated 2026-09-23 17:26 UTC. This file is written by a scheduled job -- nobody has to ask for it.

## Collection

- **1,651 closed round trips**, all collector v3, Aug 05 to Sep 23
- Newest trade **3.5 h old**
- **20 in the last 24h**, 69 in the last 7 days (9.9/day across 4 tracked wallets)
- **+2 since the last report** (2026-09-23 16:31 UTC)

## Detection lag

How stale a trade already was when the collector noticed it. This is what execution lag a row actually represents.

- Last 2 days: **median 10.4s**, p90 11.3s (27 rows)
...
|---|---|---|---|---|---|---|---|
| Cented | 2 | 28 more | +2.49 | 50% | 50% | 0.251 | 46.8 d ago |
| Sebastian | 1 | 29 more | +2.26 | 100% | 100% | nan | 48.6 d ago |
...
- **Kadenox** — last trade 5.5 d ago. Costs ~43,200 RPC calls/day regardless.
