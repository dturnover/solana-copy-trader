...
Generated 2026-09-22 03:35 UTC. This file is written by a scheduled job -- nobody has to ask for it.
...
- **+3 since the last report** (2026-09-22 03:13 UTC)

## Detection lag

How stale a trade already was when the collector noticed it. This is what execution lag a row actually represents.

- Last 2 days: **median 10.7s**, p90 12.2s (13 rows)
